...
class SimpleTodoList:
    ...
    def __init__(self, master: py_cui.PyCUI):
        ...
        self.todo_scroll_cell =         self.master.add_scroll_menu('Arduino Serial A1',  0, 0, row_span=7, column_span=2)
        self.in_progress_scroll_cell =  self.master.add_scroll_menu('Arduino Serial A2',  0, 2, row_span=7, column_span=2)
        self.done_scroll_cell =         self.master.add_scroll_menu('Display Serial D',  0, 4, row_span=7, column_span=2)

        # Textbox for entering new items
        self.new_todo_textbox = self.master.add_text_box('Python console', 7, 0, column_span=6)
