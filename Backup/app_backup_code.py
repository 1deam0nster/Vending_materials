...
class Display:
    def __init__(self, baudrate=9600, timeout=0.1):
        self.ser = serial.Serial('/dev/ttyS0', 9600, timeout=timeout, writeTimeout=timeout)
        self.command = b''
...
class Serializer:
    ...
    def read_command(self):
        ...
        if data == u'Turrel Y capsule - true\r\n':
...
def fis():
    program = "python send_fis.py"
    process = subprocess.Popen(["python", "send_fis.py"])
